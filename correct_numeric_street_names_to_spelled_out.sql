...
set new_street_name = (
	...
	then
		case when '1st' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '1st', 'First', 'g')

		when '2nd' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '2nd', 'Second', 'g')

		when '3rd' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '3rd', 'Third', 'g')

		when '4th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '4th', 'Fourth', 'g')

		when '5th' = ANY stringt_to_array(new_street_name, ' ')
	...
	then
		...
		when '8th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '8th', 'Eighth', 'g')

		when '9th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '9th', 'Ninth', 'g')

		when '10th' = ANY stringt_to_array(new_street_name, ' ')
	...
	then
		case when '2nd' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '2nd', 'Second', 'g')

		when '7th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '7th', 'Seventh', 'g')

		when '9th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '9th', 'Ninth', 'g')

		when '15th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '15th', 'Fifteenth', 'g')

		when '17th' = ANY stringt_to_array(new_street_name, ' ')
	...
	then
		case when '3rd' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '3rd', 'Third', 'g')
	...
	then
		case when '6th' = ANY stringt_to_array(new_street_name, ' ')
	...
	then
		...
		when '6th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '6th', 'Sixth', 'g')
		...
		when '12th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '12th', 'Twelfth', 'g')

		when '13th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '13th', 'Thirteenth', 'g')

		when '14th' = ANY stringt_to_array(new_street_name, ' ')
	...
	then
		...
		when '11th' = ANY stringt_to_array(new_street_name, ' ')
	...
	then
		...
		when '16th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '16th', 'Sixteenth', 'g')

		when '17th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '17th', 'Seventeenth', 'g')
		
		when '18th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '18th', 'Eighteenth', 'g')

		when '19th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '19th', 'Nineteenth', 'g')

		when '20th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '20th', 'Twentieth', 'g')

		when '21th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '21th', 'Twenty First', 'g')

		when '23th' = ANY stringt_to_array(new_street_name, ' ')
	...
	then
		case when '5th' = ANY stringt_to_array(new_street_name, ' ')
		then regexp_replace(new_street_name, '5th', 'Fifth', 'g')
